...
public class HttpClient {
	...
	public void processPutRequest(String request) throws Exception {
		...
		request = URLEncoder.encode(request,"utf-8"); //URL编码
		File fileForPut = new File(fileName);
		if(fileForPut.exists()){
			byte[] data = Files.readAllBytes(fileForPut.toPath());
			...
			System.out.println("The file you want to put does not exist!");
		}
